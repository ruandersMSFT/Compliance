...
|:--------------------|:------------|:-----------------------|
| [FedRAMP](https://sip.compliance.microsoft.com/compliancemanager) | AC-4: Information flow enforcement <br> CP-9: Information system backup <br> PL-8: Information security architecture <br> SC-7: Boundary protection <br> SC-22: Architecture and provisioning | September 24, 2020 |
